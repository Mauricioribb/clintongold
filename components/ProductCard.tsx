        ...
        <div className="p-4 flex flex-col flex-grow text-center">
          ...
          <div className="mt-auto space-y-2">
            ...
            <a 
              ...
              className="w-full flex items-center justify-center space-x-2 bg-[#25D366] text-white py-3 rounded-[10px] font-bold uppercase tracking-widest text-sm hover:bg-[#20ba5a] transition-all shadow-sm"
            >
