      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-1/2">
            ...
            <h3 className="text-4xl md:text-5xl font-bold mb-8 leading-tight uppercase tracking-tight">Sua Loja Referência em Negócios de Ouro</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
              <div className="bg-white p-6 rounded-[10px] border border-gold/10 shadow-xl transition-all duration-300 hover:-translate-y-1">
            ...
            <button className="flex items-center space-x-3 text-white font-bold tracking-widest uppercase text-xs group">
