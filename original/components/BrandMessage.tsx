  ...
  return (
    <section className="py-20 bg-black relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-8 text-center relative z-10">
        ...
        <p className="text-xl md:text-2xl lg:text-3xl font-bold leading-relaxed md:leading-snug text-white/90">
        ...
        <div className="mt-12 flex items-center justify-center -space-x-4">
          {JEWELRY_THUMBS.map((src, index) => (
            ...
            >
              <div className="w-14 h-14 md:w-16 md:h-16 rounded-full border-2 border-black overflow-hidden shadow-2xl bg-neutral-900">
                <img 
                  src={src} 
